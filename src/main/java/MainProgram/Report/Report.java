...
//
//        File f = new File("C:\\Users\\41292\\Desktop\\201801241434");
//
//        new Report(new File("D:/test", f.getName() + ".zip")).zipFiles(f);
//
//    }
